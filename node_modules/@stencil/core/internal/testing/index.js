...
const mockDoc = require("@stencil/core/mock-doc"), appData = require("@stencil/core/internal/app-data"), styles = new Map, modeResolutionChain = [], cstrs = new Map, queuedTicks = [], queuedWriteTasks = [], queuedReadTasks = [], moduleLoaded = new Map, queuedLoadModules = [], caughtErrors = [], hostRefs = new Map, consoleError = e => {
 caughtErrors.push(e);
}, consoleDevError = (...e) => {
...
let isAutoApplyingChanges = !1, autoApplyTimer = void 0;
...
const isMemberInElement = (e, t) => {
 ...
 appData.BUILD.hostListener && a && (appData.BUILD.hostListenerTargetParent && (a = o ? a.filter(([e]) => 16 & e) : a.filter(([e]) => !(16 & e))), 
 a.map(([a, o, s]) => {
...
}, getHostListenerTarget = (e, t) => appData.BUILD.hostListenerTargetDocument && 4 & t ? doc : appData.BUILD.hostListenerTargetWindow && 8 & t ? win : appData.BUILD.hostListenerTargetBody && 32 & t ? doc.body : appData.BUILD.hostListenerTargetParent && 16 & t ? e.parentElement : e, hostListenerOpts = e => ({
 passive: 0 != (1 & e),
 capture: 0 != (2 & e)
...
const createTime = (e, t = "") => {
 ...
 s();
}, getScopeId = (e, t) => "sc-" + (appData.BUILD.mode && t && 32 & e.$flags$ ? e.$tagName$ + "-" + t : e.$tagName$), computeMode = e => modeResolutionChain.map(t => t(e)).find(e => !!e), EMPTY_OBJ = {}, isComplexType = e => "object" == (e = typeof e) || "function" === e, IS_DENO_ENV = "undefined" != typeof Deno, IS_NODE_ENV = !(IS_DENO_ENV || "undefined" == typeof global || "function" != typeof require || !global.process || "string" != typeof __filename || global.origin && "string" == typeof global.origin), h = (IS_NODE_ENV ? global.process.platform : IS_DENO_ENV && globalThis.Deno.build.os, 
IS_DENO_ENV && Deno.build.os, IS_NODE_ENV && global.process.platform, IS_NODE_ENV ? process.cwd : IS_DENO_ENV && Deno.cwd, 
IS_NODE_ENV ? process.exit : IS_DENO_ENV && Deno.exit, (e, t, ...a) => {
...
const createElm = (e, t, a, o) => {
 ...
 appData.BUILD.isDev && r.$elm$ && consoleError(`The JSX ${null !== r.$text$ ? `"${r.$text$}" text` : `"${r.$tag$}" element`} node should not be shared within the same renderer. The renderer caches element lookups in order to improve performance. However, a side effect from this is that the exact same JSX node should not be reused. For more information please see https://stenciljs.com/docs/templating-jsx#avoid-shared-jsx-nodes`), 
 ...
 appData.BUILD.updatable && null !== o && null !== s ? ((e, t, a, o) => {
  let s, n, l = 0, r = 0, p = 0, i = 0, d = t.length - 1, c = t[0], $ = t[d], m = o.length - 1, D = o[0], u = o[m];
  for (;l <= d && r <= m; ) if (null == c) c = t[++l]; else if (null == $) $ = t[--d]; else if (null == D) D = o[++r]; else if (null == u) u = o[--m]; else if (isSameVnode(c, D)) patch(c, D), 
  c = t[++l], D = o[++r]; else if (isSameVnode($, u)) patch($, u), $ = t[--d], u = o[--m]; else if (isSameVnode(c, u)) !appData.BUILD.slotRelocation || "slot" !== c.$tag$ && "slot" !== u.$tag$ || putBackInOriginalLocation(c.$elm$.parentNode, !1), 
  patch(c, u), e.insertBefore(c.$elm$, $.$elm$.nextSibling), c = t[++l], u = o[--m]; else if (isSameVnode($, D)) !appData.BUILD.slotRelocation || "slot" !== c.$tag$ && "slot" !== u.$tag$ || putBackInOriginalLocation($.$elm$.parentNode, !1), 
  patch($, D), e.insertBefore($.$elm$, c.$elm$), $ = t[--d], D = o[++r]; else {
   if (p = -1, appData.BUILD.vdomKey) for (i = l; i <= d; ++i) if (t[i] && null !== t[i].$key$ && t[i].$key$ === D.$key$) {
    p = i;
    break;
   }
   appData.BUILD.vdomKey && p >= 0 ? (n = t[p], n.$tag$ !== D.$tag$ ? s = createElm(t && t[r], a, p, e) : (patch(n, D), 
   t[p] = void 0, s = n.$elm$), D = o[++r]) : (s = createElm(t && t[r], a, r, e), D = o[++r]), 
 ...
 for (a = 0, o = r.length; a < o; a++) if (t = r[a], 1 === t.nodeType) {
  if (t["s-sr"]) for (n = t["s-sn"], t.hidden = !1, s = 0; s < o; s++) if (r[s]["s-hn"] !== t["s-hn"]) if (l = r[s].nodeType, 
  "" !== n) {
 ...
 for (;r < i; r++) {
  if (t = p[r], t["s-sr"] && (a = t["s-cr"])) for (o = a.parentNode.childNodes, s = t["s-sn"], 
 ...
 if (appData.BUILD.isDev && (e.$flags$ |= 1024), (appData.BUILD.hasRenderFn || appData.BUILD.reflect) && (appData.BUILD.vdomRender || appData.BUILD.reflect ? renderVdom(e, callRender(e, t)) : o.textContent = callRender(e, t)), 
 ...
 if (appData.BUILD.asyncLoading && n && (n.map(e => e()), o["s-rc"] = void 0), l(), 
...
const callRender = (e, t) => {
 const a = !!appData.BUILD.allRenderFn, o = !!appData.BUILD.lazyLoad, s = !!appData.BUILD.taskQueue, n = !!appData.BUILD.updatable;
 try {
  renderingRef = t, t = (a || t.render) && t.render(), n && s && (e.$flags$ &= -17), 
  (n || o) && (e.$flags$ |= 2);
 } catch (e) {
  consoleError(e);
 }
 ...
 appData.BUILD.isDev && (1024 & s.$flags$ || s.$flags$), !appData.BUILD.lazyLoad || p)) {
 ...
 if (appData.BUILD.member && t.$members$) {
  ...
  if (o.map(([e, [o]]) => {
   (appData.BUILD.prop || appData.BUILD.state) && (31 & o || (!appData.BUILD.lazyLoad || 2 & a) && 32 & o) ? Object.defineProperty(s, e, {
    ...
    set(s) {
     appData.BUILD.isDev && 0 == (1 & a) && 31 == (1055 & o) && t.$tagName$, setValue(this, e, s, t);
    },
    configurable: !0,
    enumerable: !0
...
exports.Build = {
 ...
 isServer: !0,
 isTesting: !0
}, exports.Context = Context, exports.Host = Host, exports.addHostEventListeners = addHostEventListeners, 
...
exports.consoleDevInfo = (...e) => {}, exports.consoleDevWarn = (...e) => {}, exports.consoleError = consoleError, 
exports.createEvent = (e, t, a) => {
 const o = getElement(e);
 return {
  emit: e => (appData.BUILD.isDev && o.isConnected, emitEvent(o, t, {
   bubbles: !!(4 & a),
   composed: !!(2 & a),
   cancelable: !!(1 & a),
   detail: e
...
}, exports.setAssetPath = e => plt.$resourcesUrl$ = e, exports.setMode = e => modeResolutionChain.push(e), 
