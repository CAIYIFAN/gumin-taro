...
if (typeof Object.defineProperties !== 'function') {
  Object.defineProperties = function (obj, properties) {
    function convertToDescriptor(desc) {
      ...
      if (_typeof$1(desc) !== 'object' || desc === null) {
    ...
    if (_typeof$1(obj) !== 'object' || obj === null) throw new TypeError('bad obj');
...
var Link = /*#__PURE__*/function () {
  ...
  _createClass$1(Link, [{
    ...
    value: function request(requestParams) {
      ...
      return this.chain.proceed(_objectSpread2$1({}, requestParams));
    }
  }, {
    key: "addInterceptor",
...
function setHistoryMode(mode, basename) {
  ...
  if (mode === 'hash') {
    exports.history = createHashHistory(obj);
  } else {
    // default is browser
    exports.history = createBrowserHistory(obj);
  }
}
...
function init(config) {
  ...
  Object.assign(routerConfig, config); // eslint-disable-next-line no-unused-expressions
...
var routerConfig = Object.create({});
...
var taro = _objectSpread2(_objectSpread2({}, rest), {}, {
  getEnv: getEnv$1,
  ENV_TYPE: ENV_TYPE$1,
  Events: Events,
...
var canvasToTempFilePath = function canvasToTempFilePath(_ref) {
  var canvasId = _ref.canvasId,
