    ...
    fs.readdirSync(dirPath).forEach(file => {
        ...
        if (fs.statSync(filePath).isFile()) {
            if (path.extname(filePath) === '.js') {
                Object.assign(exports.declarations, require(filePath).default);
            }
        }
        else {
...
function rewriter(declaration, rule, output) {
    ...
    if (exports.declarations.hasOwnProperty(declaration.property)) {
        let processDeclaration = exports.declarations[declaration.property];
