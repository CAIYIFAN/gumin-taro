...
class TaroMiniPlugin {
    constructor(options = {}) {
        ...
        this.options = Object.assign({
            ...
            templateAdapter: adapters_1.weixinAdapter
        }, options);
        adapters_1.setAdapter(this.options.templateAdapter);
    }
    /**
     * 插件入口
     */
    ...
    generateMiniFiles(compilation) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.generateTemplateFile(compilation, baseTemplateName, template_1.buildBaseTemplate, baseLevel, isSupportRecursive);
