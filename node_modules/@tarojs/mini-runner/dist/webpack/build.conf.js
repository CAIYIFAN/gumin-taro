...
exports.default = (appPath, mode, config) => {
    ...
    const { buildAdapter = helper_1.PLATFORMS.WEAPP, alias = {}, entry = {}, output = {}, fileType = {
        ...
        script: '.js',
        templ: '.wxml'
    }, templateAdapter = adapters_1.weixinAdapter, isSupportXS = true, globalObject = 'wx', outputRoot = 'dist', sourceRoot = 'src', designWidth = 750, deviceRatio, enableSourceMap = process.env.NODE_ENV !== 'production', baseLevel = 16, framework = 'nerv', prerender, defineConstants = {}, env = {}, cssLoaderOption = {}, sassLoaderOption = {}, lessLoaderOption = {}, stylusLoaderOption = {}, mediaUrlLoaderOption = {}, fontUrlLoaderOption = {}, imageUrlLoaderOption = {}, miniCssExtractPluginOption = {}, postcss = {}, nodeModulesPath, isBuildQuickapp = false, isSupportRecursive = false, quickappJSON, csso, terser, commonChunks, addChunkPages, modifyMiniConfigs, modifyBuildAssets } = config;
    let { copy } = config;
    const plugin = {};
    const minimizer = [];
